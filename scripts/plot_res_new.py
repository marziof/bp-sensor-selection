...
FILE_NAME = "full_sweep_rnd_pinf_neigh_seq_ov_mov_c_mov_rrg_N300_T10_d3_Nsim5_del01_02_03_04.csv"  # "full_sweep_rnd_seq_ov_mov_c_mov_rrg_N300_T10_d3_Nsim5_del0.3.csv"
PATH = f"{FILE_DIR}/{FILE_NAME}" 
results_df = pd.read_csv(PATH)

results_df2 = pd.read_csv(f"{FILE_DIR}/full_sweep_rnd_seq_ov_mov_c_mov_rrg_N300_T10_d3_Nsim5_del0.05_0.2_0.4.csv")
