...
FILE_NAME = "full_sweep_log_cone3mod_rnd_seq_ov_rrg_N300_T10_d3_Nsim10_del005_02.csv"  # "full_sweep_rnd_seq_ov_mov_c_mov_rrg_N300_T10_d3_Nsim5_del0.3.csv"
PATH = f"{FILE_DIR}/{FILE_NAME}" 
results_df = pd.read_csv(PATH)

# results_df2 = pd.read_csv(f"{FILE_DIR}/full_sweep_log_influence3_rnd_seq_ov_rrg_N100_T10_d3_Nsim5_del03.csv")

# results_df3 = pd.read_csv(f"{FILE_DIR}/full_sweep_rnd_seq_ov_mov_c_mov_rrg_N300_T10_d3_Nsim5_del0.3.csv")
...
SAVE_TITLE = f"ov_comparison_N300_T10_d3_Nsim10_ov_del{delta_str}_cone3mod"#f"N100_T10_d3_Nsim5_del{delta_str}_cone" #overlap_comparison_N300_T10_d3_Nsim5_del0.3.png"
...
#     delta_str = str(delta).replace(".", "")
#     SAVE_DIR = "results_new/plots"
#     SAVE_TITLE = f"N300_T10_d3_Nsim5_del{delta_str}_pinf_neigh" #overlap_comparison_N300_T10_d3_Nsim5_del0.3.png"
#     SAVE_PATH = f"{SAVE_DIR}/{SAVE_TITLE}"
...
#plot_delta_comparison(results_df, eval_metric="O_tilde", method_metric=method_metric, save=True, title=None, save_path=f"{SAVE_DIR}/delta_comparison_O_tilde_{method_metric}_{SAVE_TITLE}")
